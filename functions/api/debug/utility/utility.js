 ...
 * 
 * @description
 * This function is used to make response for web
 */
 ...
 * 
 * @description
 * This function is used to make response for game
 */
 ...
 * 
 * @description
 * This function is used to make response for app
 */
 ...
 * 
 * @description
 * This function is used to make error response
 */
 ...
 * 
 * @description
 * This function is used to check if request has valid path
 */
 ...
 * 
 * @description
 * This function is used to decode params from support path and return it as object
 */
...
const proccessGameSession = async (sessionJSON) => {
    const _playerSessionModel = require("../models/playerSessionModel");
    const _gameDataModel = require("../models/gameDataModel");

    //* Create Player Session Data Model from JSON
    const playerSessionModel = _playerSessionModel().fromJSON(sessionJSON);

    let playerActivityRef = dabaseRefs.userActivity(playerSessionModel.userId);
...
const dabaseRefs = {
    userProfile: (uid) => db.ref(databsePaths.userProfile + uid),
    userStats: (uid) => db.ref(databsePaths.userStats + uid),
    player: (uid, pid) => db.ref(databsePaths.userProfile + uid + "/players/" + pid),
    playerActivity: (uid, pid) => db.ref(databsePaths.userProfile + uid + "/players/" + pid + "/activity-statistics"),
    game: (gid) => db.ref(databsePaths.inventory + "games/" + gid),
    // leads : (_id) => db.ref(databsePaths.leads+_id)
}
...
exports.database = {
    ...
    fgd: {
        read: {
            fgd: async (gameId, userId, playerId) => {
                let ref = await db.ref(databsePaths.fgd + userId + "/" + playerId + "/" + gameId).once("value");
                return ref.val();
            }
        },
        write: {
            session: async (gameId, userId, playerId, session) => {
                let processResponse = proccessGameSession(session);
    ...
    // leads:{
    //     read : {
    //         firstName: async (userId, firstname) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/name").get(firstname);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //             }
    //         },
    //         lastName: async (userId, lastname) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/name").get(lastname);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         email: async (userId, email) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/email").get(email);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //             }
    //         },
    //         mobile: async (userId, mobile) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/mobile").get(mobile);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //             }
    //         },
    //         address1: async (userId, address1) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/address").get(address1);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //             }
    //         },
    //         address2: async (userId, address2) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/address").get(address2);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //             }
    //         },
    //         zip: async (userId, zip) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/location").get(zip);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //             }
    //         },
    //         country: async (userId, country) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/location").get(country);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //             }
    //         },
    //         state: async (userId, state) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/location").get(state);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         firstName: async (userId, firstname) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/name").set(firstname);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         lastName: async (userId, lastname) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/name").set(lastname);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         email: async (userId, email) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/email").set(email);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         mobile: async (userId, mobile) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/mobile").set(mobile);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         address1: async (userId, address1) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/address").set(address1);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         address2: async (userId, address2) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/address").set(address2);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         zip: async (userId, zip) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/location").set(zip);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         country: async (userId, country) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/location").set(country);
    //                 return true;
    //             }
    //             catch (error) {
    ...
    //         state: async (userId, state) => {
    //             try {
    //                 await db.ref(databsePaths.leads + userId + "/location").set(state);
    //                 return true;
    //             }
    //             catch (error) {
